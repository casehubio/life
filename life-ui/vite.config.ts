...
export default defineConfig({
  ...
  resolve: {
    alias: [
      { find: /^@casehubio\/blocks-ui-core\/(.*)/, replacement: resolve(blocksUi, 'blocks-ui-core/dist/$1') },
      ...
      { find: '@casehubio/blocks-ui-audit-trail-viewer', replacement: resolve(blocksUi, 'audit-trail-viewer') },
      { find: '@casehubio/blocks-ui-routing-rationale', replacement: resolve(blocksUi, 'routing-rationale') },
      { find: '@casehubio/blocks-ui-similarity-panel', replacement: resolve(blocksUi, 'similarity-panel') },
      { find: '@casehubio/blocks-ui-channel-activity', replacement: resolve(blocksUi, 'channel-activity') },
      { find: '@casehubio/blocks-ui-commitment-viz', replacement: resolve(blocksUi, 'commitment-viz') },
      { find: '@casehubio/blocks-ui-approval-gate', replacement: resolve(blocksUi, 'approval-gate') },
      { find: '@casehubio/blocks-ui-trust-score-panel', replacement: resolve(blocksUi, 'trust-score-panel') },
      { find: '@casehubio/blocks-ui-compliance-summary', replacement: resolve(blocksUi, 'compliance-summary') },
      { find: '@casehubio/blocks-ui-blocks-timeline', replacement: resolve(blocksUi, 'blocks-timeline') },
  ...
  server: {
    proxy: {
      ...
      '/api/v1/ledger': 'http://127.0.0.1:8080',
